...
if(frlio_CONFIG_INCLUDED)
  return()
endif()
set(frlio_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(frlio_SOURCE_PREFIX /home/apple-pie/SLAM/fr-lio/codes/frlio/ros_app)
  set(frlio_DEVEL_PREFIX /home/apple-pie/SLAM/fr-lio/codes/frlio/ros_app/build/devel)
  set(frlio_INSTALL_PREFIX "")
  set(frlio_PREFIX ${frlio_DEVEL_PREFIX})
else()
  set(frlio_SOURCE_PREFIX "")
  set(frlio_DEVEL_PREFIX "")
  set(frlio_INSTALL_PREFIX /usr/local)
  set(frlio_PREFIX ${frlio_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'frlio' is deprecated")
...
set(frlio_FOUND_CATKIN_PROJECT TRUE)
...
if(NOT "/usr/include/eigen3;/usr/include/pcl-1.10;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2 " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Zhao Xiaoyu <928674428@qq.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    if(IS_ABSOLUTE ${idir} AND IS_DIRECTORY ${idir})
      set(include ${idir})
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${frlio_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'frlio' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'frlio' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/apple-pie/SLAM/fr-lio/codes/frlio/ros_app/${idir}'.  ${_report}")
    endif()
    _list_append_unique(frlio_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND frlio_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND frlio_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT frlio_NUM_DUMMY_TARGETS)
      set(frlio_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::frlio::wrapped-linker-option${frlio_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR frlio_NUM_DUMMY_TARGETS "${frlio_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::frlio::wrapped-linker-option${frlio_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND frlio_LIBRARIES "${interface_target_name}")
  elseif(${library} MATCHES "^\\$<")
    list(APPEND frlio_LIBRARIES ${library})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/apple-pie/SLAM/fr-lio/codes/frlio/ros_app/build/devel/lib;/opt/ros/noetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(frlio_LIBRARY_DIRS ${lib_path})
      list(APPEND frlio_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'frlio'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND frlio_LIBRARIES ${lib})
    endif()
  endif()
...
set(frlio_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${frlio_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 frlio_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${frlio_dep}_FOUND)
      find_package(${frlio_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${frlio_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(frlio_INCLUDE_DIRS ${${frlio_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(frlio_LIBRARIES ${frlio_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${frlio_dep}_LIBRARIES})
  _list_append_deduplicate(frlio_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(frlio_LIBRARIES ${frlio_LIBRARIES})

  _list_append_unique(frlio_LIBRARY_DIRS ${${frlio_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(frlio_EXPORTED_TARGETS ${${frlio_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${frlio_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
